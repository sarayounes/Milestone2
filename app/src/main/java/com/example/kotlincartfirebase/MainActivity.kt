...
import com.example.kotlincartfirebase.adapter.MyDrinkAdapter
...
import com.example.kotlincartfirebase.listener.IDrinkLoadListener
            ...
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                   if(snapshot.exists())
                   {
                       ...
                       drinkLoadListener.onDrinkLoadFailed("Drink items doesn't exist")
                }
