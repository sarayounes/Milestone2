package com.example.kotlincartfirebase.adapter
...
import com.example.kotlincartfirebase.listener.IRecyclerClickListener
...
class MyDrinkAdapter (
    ...
    override fun onBindViewHolder(holder: MyDrinkViewHolder, position: Int) {
        ...
        holder.txtPrice!!.text = StringBuilder("egp").append(list[position].price)
